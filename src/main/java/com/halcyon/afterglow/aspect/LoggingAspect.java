package com.halcyon.afterglow.aspect;
...
public class LoggingAspect {
    ...
    @Before("execution(* com.halcyon.afterglow.service.*.*.*(..))")
    ...
    @AfterReturning(pointcut = "execution(* com.halcyon.afterglow.service.*.*.*(..))", returning = "result")
    ...
    @AfterThrowing(pointcut = "execution(* com.halcyon.afterglow.service.*.*.*(..))", throwing = "ex")
